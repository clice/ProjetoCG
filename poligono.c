...
/*
 * FUNÇÃO PARA REFLETIR UM POLÍGONO
 */
int refletirPoligono(int chave, ListaPoligonos * listaPoligonos, Matriz3Por3 * matrizReflexaoPoligono)
{
	...
	// Refletir um polígono
		...
		while (atualPontoPoligono != NULL) {
			...
			// Realizar a multiplicação para a transformação
			matrizPontoPoligono = multiplicarMatriz3Por3PorMatriz3Por1(matrizReflexaoPoligono, matrizPontoPoligono);
...
/*
 * FUNÇÃO PARA CISALHAR UM POLÍGONO
 */
